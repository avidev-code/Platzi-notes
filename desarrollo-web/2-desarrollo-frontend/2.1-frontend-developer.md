...
<details>
  ...
  **Contenido:** es el texto o elementos encerrados por la etiqueta, este valor es opcional en algunas de ellas.<br/><br/>
...
<details>
  ...
  Ahora que ya conoces las etiquetas semánticas, evita el uso excesivo de `<div>`.<br/>
...
```html
<h1style=""color:blue;">Especificidad</h1>
```
...
Si utilizas Visual Studio Code y mantienes el *mouse* sobre el selector, te mostrará la especificidad total.

**Specificity Calculator** es una página web donde puedes calcular la especificidad.
